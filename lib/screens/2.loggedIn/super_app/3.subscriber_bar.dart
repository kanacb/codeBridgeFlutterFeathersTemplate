...
class SubscribeLoggedInBar extends StatefulWidget {
  const SubscribeLoggedInBar({super.key});

  @override
  State<SubscribeLoggedInBar> createState() => _SubscribeLoggedInBarState();
}

class _SubscribeLoggedInBarState extends State<SubscribeLoggedInBar> {
