...
class SearchLoggedInBar extends StatefulWidget {
  const SearchLoggedInBar({
    super.key,
  });

  @override
  State<SearchLoggedInBar> createState() => _SearchLoggedInBarState();
}

class _SearchLoggedInBarState extends State<SearchLoggedInBar> {
  @override
